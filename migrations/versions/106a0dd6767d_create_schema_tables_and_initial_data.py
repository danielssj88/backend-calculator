...
Revision ID: 106a0dd6767d
Revises: 
Create Date: 2023-05-08 15:07:50.302855
...
def upgrade() -> None:
    ...
    # Create initial data
    op.execute("INSERT INTO users (username, password) VALUES ('danielssj88', 'pbkdf2:sha256:600000$wFgruEtmmlotYG7I$76d6824c8f1f3bc26edf54f000546e6c2c496231d2dba29b0397eebabfb330bb')")
    op.execute("INSERT INTO users (username, password) VALUES ('test.trueNorth', 'pbkdf2:sha256:600000$wyn7ogSmgfFs5noi$2ee53c985f35929312473f2e5af67cd20f72e77d726d320f0cfa94803a6c77a4')")
